...
function calcularOther () {
    ...
    let Othervalue0 = receberValorOther * 100 / 95.65
    let Othervalue1 = receberValorOther * 100 / 95.65
    let Othervalue2 = receberValorOther * 100 / 93.92
    let Othervalue3 = receberValorOther * 100 / 92.98
    let Othervalue4 = receberValorOther * 100 / 92.03
    let Othervalue5 = receberValorOther * 100 / 91.18
    let Othervalue6 = receberValorOther * 100 / 90.13
    let Othervalue7 = receberValorOther * 100 / 88.18
    let Othervalue8 = receberValorOther * 100 / 82.19
    let Othervalue9 = receberValorOther * 100 / 86.21
    let Othervalue10 = receberValorOther * 100 / 85.22
    let Othervalue11 = receberValorOther * 100 / 84.21
    let Othervalue12 = receberValorOther * 100 / 83.19
    let Othervalue13 = receberValorOther * 100 / 82.18
    let Othervalue14 = receberValorOther * 100 / 81.16
    let Othervalue15 = receberValorOther * 100 / 80.14
    let Othervalue16 = receberValorOther * 100 / 79.11
    let Othervalue17 = receberValorOther * 100 / 78.01
    let Othervalue18 = receberValorOther * 100 / 77.01
...
function calcular () {
    ...
    let value0 = receberValor * 100 / 95.65
    let value1 = receberValor * 100 / 95.65
    let value2 = receberValor * 100 / 93.92
    let value3 = receberValor * 100 / 92.98
    let value4 = receberValor * 100 / 92.03
    let value5 = receberValor * 100 / 91.18
    let value6 = receberValor * 100 / 90.13
    let value7 = receberValor * 100 / 88.18
    let value8 = receberValor * 100 / 82.19
    let value9 = receberValor * 100 / 86.21
    let value10 = receberValor * 100 / 85.22
    let value11 = receberValor * 100 / 84.21
    let value12 = receberValor * 100 / 83.19
    let value13 = receberValor * 100 / 82.18
    let value14 = receberValor * 100 / 81.16
    let value15 = receberValor * 100 / 80.14
    let value16 = receberValor * 100 / 79.11
    let value17 = receberValor * 100 / 78.01
    let value18 = receberValor * 100 / 77.01
